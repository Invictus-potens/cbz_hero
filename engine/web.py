...
class WebResource:
    ...
    def __init__(self, url, path=None, headers=None):
        ...
        self.pagedata = None
        self.response = None
        # sent on top of the User-Agent - some sites require a referer or a cookie
        self.extra_headers = dict(headers) if headers else {}

    def getImageHeaders(self):
        """ Headers a module needs the page's image request to carry

        Override in a module's Page class when the image host is picky.
        """
        return {}
